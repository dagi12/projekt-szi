...
//                    Table l = Waiter.getInstance().getTargetLocation();
...
//                currentLocation.setText("X: " + ((Table) arg).getX() + " Y: " + ((Table) arg).getY());
//                Field f = Map.getInstance().getFieldAt((Table) arg);
...
//                TreeMap<Table, Field> fieldMap = (TreeMap<Table, Field>) arg;
